...
describe Product do
  ...
  let (:prod2_attrs) { {asin: 'B00CTGB4M6', buylink: 'link', large_image: 'l_image', medium_image: 'm_image', small_image: 's_image', department: 'mens', asins_of_sim_prods: "B00CTGB4OO,B00CTGB5FW,B00CTGB2X2,B00CTGB1Y2"}}
